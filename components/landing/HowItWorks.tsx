    ...
    <section ref={ref} className="py-28 px-6 bg-surface-800/20 relative overflow-hidden">
      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-slate-400">Five steps from offer to settlement — fully automated.</p>
        </motion.div>
            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative z-10 w-20 h-20 rounded-full bg-surface-800 border border-[rgba(255,255,255,0.08)] flex items-center justify-center text-3xl"
